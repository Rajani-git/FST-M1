...
public class Project_Activity5 {
    ...
    public <string> void Login() {
        ...
        //Finding the color of the Navigation Bar
        WebElement cssLocator = driver.findElement(By.className("desktop-toolbar"));
       // string Bgcolor = cssLocator.getCssValue("background-color");
        System.out.println("Color of the Navigating Bar: " + cssLocator.getCssValue("background-Color"));
    }
